...
namespace KantoorApplicatie.Views
{
    public partial class NewObjectForm : Form
    {
        ...
        public NewObjectForm(CatalogPanel cp)
        {
        ...
        private void GenerateButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string workingPath = Path.GetDirectoryName(Path.GetDirectoryName(Directory.GetCurrentDirectory()));
                workingPath = Path.Combine(workingPath, "ProductImages");
        ...
        private void NewObjectForm_Load(object sender, EventArgs e) {
            // Plak er een label bij ofzo met "Selecteer een type."
